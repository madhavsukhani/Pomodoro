...
completeSessionBtn.addEventListener('click', () => {
    ...
    let currentSessions = parseInt(completedSessions.textContent);
    currentSessions += 1; // Increment by 1 (you can change this if needed)

    // Update the displayed number of sessions
    completedSessions.textContent = currentSessions;
});
